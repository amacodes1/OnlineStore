...
export default function Newsletter() {
  return (
    <div>
      <div className="Newsletter w-full h-[865px] md:h-[600px] px-6 py-20 md:py-32 md:px-20  md:rounded-lg bg-green500 flex-col md:flex-row justify-start items-center gap-[52px] inline-flex">
